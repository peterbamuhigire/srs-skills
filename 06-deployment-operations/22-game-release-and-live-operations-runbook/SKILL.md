...
| Data/economy config, capacity, support and communications | Specialist owners | Conditional | Disable or block affected live scope. |
## Workflow
...
6. Gate config/events with schema, approval, expiry, kill switch and reversal.
7. Stop on missing rollback, symbols or owner; recover by holding rollout.
## Outputs
