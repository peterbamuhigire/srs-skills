...
1. Verify `../project_context/tech_stack.md` exists. Halt if it is missing.
2. Invoke `logic.prompt` or trigger the skill. The skill reads VCS and CI/CD details, generates workflow standards, and writes `../output/Contribution_Guide.md`.
