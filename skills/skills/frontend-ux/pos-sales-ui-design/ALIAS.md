...
description: Design POS, checkout, and sales entry web UIs that are simple, accessible,
  and fast for all ages while integrating all backend actions strictly through APIs.
  Use for creating or reviewing UI patterns, layouts, components, and workflows for...
metadata:
  portable: true
  compatible_with:
  - Codex
...
- The task is unrelated to `pos-sales-ui-design` or would be better handled by a more specific companion skill.
...
|----------|----------|--------|---------|
| UX quality | POS sales UI audit | Markdown doc covering speed-of-input, accessibility for all ages, and back-of-house integration findings | `docs/pos/sales-ui-audit.md` |
