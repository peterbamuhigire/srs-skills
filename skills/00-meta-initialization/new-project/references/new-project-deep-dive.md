# New Project Scaffold Deep Dive

This file contains extended guidance moved out of [../SKILL.md](../SKILL.md) so the active skill entrypoint stays under the repository size limit.
