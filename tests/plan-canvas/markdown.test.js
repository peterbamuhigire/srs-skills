 ...
 *
 * Run with: node tests/plan-canvas/markdown.test.js
 *
 * Ported verbatim from ECC's tests/lib/plan-canvas-markdown.test.js
 * (C:SERSPETERDOWNLOADSCC-main) - only this header and the
 * require path below were touched.
 */
