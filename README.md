...
## Game Software Delivery Stack

Game projects now route through seven phase-placed documentation skills while implementation doctrine remains in the canonical engineering game-development family:

- `01-strategic-vision/15-game-product-and-production-brief`
- `02-requirements-engineering/19-game-software-requirements-specification`
- `03-design-documentation/17-game-system-architecture-specification`
- `04-development-artifacts/05-game-technical-implementation-specification`
- `05-testing-documentation/09-game-test-and-player-evidence-plan`
- `06-deployment-operations/22-game-release-and-live-operations-runbook`
- `09-governance-compliance/30-game-delivery-evidence-and-greenlight-pack`

The stack maintains `GHYP/GREQ/GARCH/GIMPL/GTEST` traces across player experience, gameplay state, engines/platforms, multiplayer, saves, content, performance, accessibility/localisation, security/abuse, telemetry/economy, reproducible builds, rollout and rollback. Documentation completeness never substitutes for executable builds, target-device evidence, failed-path tests or independent replication.
...
- `02-requirements-engineering/18-embedded-accounting-engine-srs/SKILL.md`
- `03-design-documentation/16-accounting-engine-design/SKILL.md`
- `05-testing-documentation/08-accounting-engine-test-plan/SKILL.md`
- `06-deployment-operations/21-accounting-operations-runbook/SKILL.md`

These skills specify the canonical single-engine accounting pattern: one tenant-scoped append-only ledger, one posting service, mapping-layer account resolution, reversing journals, period locks, subledger reconciliation, report rebuilds, and per-tenant integrity jobs.

## Retail Operating-Model Additions

For retail, omnichannel, e-commerce, POS, merchandising, pricing, promotions, markdowns, loyalty, CRM, fulfilment, returns, store operations, shrink, vendor funding, private label, planogram, or retail dashboard projects, load:

- `02-requirements-engineering/retail-operating-model-srs/SKILL.md`
- `domains/retail/references/retail-operating-model.md`
- `domains/retail/references/finance-control-gates.md`

These files extend the retail domain pack beyond catalogue/POS/checkout into a full operating-model SRS: entities, state changes, source events, interface contracts, finance/control gates, dashboard lineage, and deterministic acceptance tests. If the project touches stock value, refunds, discounts, vendor funding, POS settlement, shrink, loyalty liabilities, or financial KPIs, also route to the finance doctrine engine before release.
