...
| Player, rights, security, access, platform and independent evidence | Specialist owners | Conditional | Mark claim not assessed or fail its gate. |
## Workflow
...
3. Check rights, device, online, security, access, data/economy, release and support gates.
4. Separate documentation completeness from executed proof and replication.
5. Record pass, conditional pass or fail with blockers, waivers and approver.
6. Stop on fabricated or mismatched evidence; recover by removing the claim.
## Outputs
