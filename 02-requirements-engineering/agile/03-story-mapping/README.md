...
1. Ensure `../output/user_stories.md` and `../output/epic_breakdown.md` exist. Run `01-user-story-generation` first if they are missing.
...
3. Verify that `../output/story_map.md` and `../output/story_map.mmd` were generated. Confirm the Mermaid diagram renders without syntax errors.
