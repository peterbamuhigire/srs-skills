...
1. Run `python interface_specification.py` from this directory. The script reads the three context files, identifies external actors, validates protocol compatibility (e.g., OCI APIs, MySQL ports), and writes Section 3.1 into `projects/<ProjectName>/<phase>/<document>/SRS_Draft.md`.
