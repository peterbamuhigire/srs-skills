...
| 2 | Outpatient Department (OPD) | Core Clinical | All | 1 | SOAP consultation, ICD-10/11 diagnosis, stock-aware prescribing |
| 3 | Laboratory Information System (LIS) | Core Clinical | All | 1 | Sample tracking, result validation, auto-analyser interface |
...
| 22 | Medical Records and Health Information | Administrative | All | 2 | Paper file tracking, discharge archive, medical certificates |
...
| 25 | Insurance Management | Financial | All | 2 | Scheme register, pre-authorisation, claim submission |
...
| 31 | Patient Portal and Mobile App | Patient Portal and Mobile | All | 3 | Personal health record, test results, mobile money payment |

Total: 31 modules across 6 categories, 4 build phases, and 3 tier levels.

---

## 5.2 Core Clinical Modules

### 5.2.1 Patient Registration and Master Index
...
- Auto-generate a unique Medical Record Number (MRN) in a format configurable per facility
- Look up returning patients by name, phone number, national ID, NIN, or fingerprint
- Classify patients by category: adult, paediatric, staff, VIP, indigent/sponsored, refugee
...
- Maintain a triage queue sorted by triage level
- Perform cross-facility lookup via the global patient identity layer
...
### 5.2.2 Outpatient Department (OPD)

**Category:** Core Clinical | **Tier:** All | **Phase:** 1

**Scope Statement:** The OPD module manages the end-to-end outpatient clinical workflow from triage through consultation, investigation ordering, prescribing, and referral. It is the primary daily workflow for most facilities and auto-captures data required for HMIS 105 reporting.
...
- Check drug interactions with a four-tier alert system: Info, Warning, Serious, Fatal
- Record minor procedures performed in the OPD
- Generate internal, external, and electronic referral letters
...
### 5.2.3 Laboratory Information System (LIS)

**Category:** Core Clinical | **Tier:** All | **Phase:** 1

**Scope Statement:** The LIS module manages the laboratory workflow from test request through sample collection, processing, result entry, validation, and reporting. It interfaces with auto-analysers via HL7 and supports external lab referrals for tests that exceed the facility's capacity.
...
- Refer specimens to external laboratories (Lancet, Central Public Health Laboratories)
...
- Valuate stock using FIFO and weighted average methods
...
### 5.2.5 Inpatient Department (IPD) and Ward Management

**Category:** Core Clinical | **Tier:** All | **Phase:** 2

**Scope Statement:** The IPD module manages patient admission, bed allocation, nursing and medical documentation, medication administration, and discharge. It provides real-time bed visibility and charge accumulation throughout the admission.
...
- Request inpatient investigations (laboratory, radiology)
- Transfer patients between wards with receiving nurse acknowledgment
- Generate discharge summaries and letters, record DAMA (Discharge Against Medical Advice)
- Accumulate inpatient charges in real time
- Provide a live patient census per ward
...
### 5.2.6 Emergency Department (A&E)
...
### 5.2.7 Maternity, ANC and Reproductive Health
...
### 5.2.8 Immunisation and Vaccination
...
### 5.3.1 HIV/AIDS Programme Management
...
### 5.3.5 Theatre and Surgical Management
...
### 5.3.6 Blood Bank and Transfusion
...
### 5.3.7 Mortuary Management

**Category:** Specialty and Programme | **Tier:** All | **Phase:** 2

**Scope Statement:** The Mortuary module manages the workflow from death notification through body storage, cause-of-death certification, autopsy recording, and regulatory notifications. It generates the documentation required by NIRA and supports maternal and perinatal death surveillance.
...
### 5.3.9 Physiotherapy and Rehabilitation
...
### 5.4.1 Appointments and Scheduling
...
### 5.4.3 Human Resource and Payroll
...
### 5.4.4 Medical Records and Health Information

**Category:** Administrative | **Tier:** All | **Phase:** 2

**Scope Statement:** The Medical Records module manages the physical file tracking workflow for facilities that maintain paper records alongside the electronic system. It tracks file movements, generates missing file reports, and archives discharge summaries.
...
### 5.5.1 Billing and Revenue Management
...
### 5.5.2 Insurance Management

**Category:** Financial | **Tier:** All | **Phase:** 2

**Scope Statement:** The Insurance Management module manages insurance scheme registration, member eligibility verification, benefit schedule enforcement, pre-authorisation, claim generation, and claim reconciliation. It supports the diverse insurance landscape in Uganda including the forthcoming National Health Insurance Scheme (NHIS).
...
### 5.5.4 Inventory and Stores Management
...
### 5.6.3 Community Health Integration
...
### 5.7.1 Patient Portal and Mobile App

**Category:** Patient Portal and Mobile | **Tier:** All | **Phase:** 3

**Scope Statement:** The Patient Portal provides patients with access to their personal health records, investigation results, appointment management, billing information, and health education through a mobile application. It supports family accounts, offline access, and multiple communication channels for low-connectivity environments.
...
- Luganda language interface as the primary local language option
...
### 5.8.1 Multi-Tenancy and Tenant Isolation
...
### 5.8.4 Country Configuration Layer
...
### 5.8.6 Director Platform (Multi-Facility)
