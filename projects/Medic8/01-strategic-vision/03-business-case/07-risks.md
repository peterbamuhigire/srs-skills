...
| R-04 | ClinicMaster pivots to SaaS -- ClinicMaster re-architects as cloud SaaS, closing its primary architectural gap and competing directly on delivery model | Competitive | LOW | HIGH | Maintain velocity advantage; ClinicMaster's desktop architecture makes SaaS migration a multi-year effort; focus on differentiators ClinicMaster cannot easily replicate (mobile money, FHIR, offline-first, PEPFAR reporting) | Peter |
...
The matrix classifies risks into 3 probability levels (Low, Medium, High) and 3 impact levels (Medium, High, Critical). Risk numbers correspond to the Risk Register above.
...
r                +-----------+-----------+-----------+
o  Low           |   R-09    | R-04,R-10 | R-07,R-08 |
b                +-----------+-----------+-----------+
```
