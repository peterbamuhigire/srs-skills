...
| FR-MFG-055-061 | 9.6 | Finite scheduling, sequence-dependent changeover, dispatch priority, green production KPIs, variance records, and simulation export | BG-003, BG-005 | Schedule a constrained order set with material and capacity limits; verify overload flags, setup recalculation, resource-intensity capture, KPI output, and scenario export lineage. |
