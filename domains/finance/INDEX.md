...
- [accounting-requirements-gate.md](references/accounting-requirements-gate.md) — requirements gate for accounting engines, POS/ERP finance, IFRS-aware reporting, management accounting, controls, reconciliations, and acceptance criteria
