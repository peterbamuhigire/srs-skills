...
1. Verify `../project_context/quality_standards.md` exists. Optionally check for `../project_context/tech_stack.md`. Halt if the required file is missing.
2. Invoke `logic.prompt` or trigger the skill. The skill generates criteria across six categories and two aggregate levels, then writes `../output/Definition_of_Done.md`.
